...
plt.figure(figsize=(8, 6))
corr = df[["edad", "salario", "satisfaction"]].corr()
sns.heatmap(corr, annot=True, cmap="coolwarm", center=0)
plt.title("Correlación")
# plt.show()
plt.savefig("grafico5.png", dpi=300)

# Countplot (barras para categorías)
plt.figure(figsize=(8, 5))
sns.countplot(x="departamento", data=df, palette="Set2", hue="departamento")
plt.title("Empleados por departamento")
# plt.show()
plt.savefig("grafico6.png", dpi=300)
...
# plt.show()
plt.savefig("grafico7.png", dpi=300)
